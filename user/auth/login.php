...
<section class="relative w-full min-h-[calc(100vh-70px)] bg-zinc-950 text-zinc-50 flex items-center justify-center px-4 py-12 overflow-hidden">
  ...
  <div class="card-animate relative z-10 w-full max-w-md border border-yellow-400/20 bg-zinc-900/85 backdrop-blur-md shadow-[0_0_50px_rgba(251,191,36,0.10)] rounded-xl p-6">
    ...
    <div class="bg-[#0f0f10] border border-zinc-800 rounded-lg p-1 grid grid-cols-2 mb-6">
      <a href="login.php" class="text-center py-2 text-xs font-bold tracking-wide rounded-md transition-all bg-[#1c1c1e] text-yellow-400 shadow-[inset_0_0_0_1px_#FBBF24]">Masuk</a>
      <a href="register.php" class="text-center py-2 text-xs font-medium tracking-wide rounded-md transition-all text-zinc-400 hover:text-zinc-200">Daftar</a>
    </div>
    ...
    <form action="" method="POST" class="space-y-5">
      ...
      <div class="grid gap-2">
        <label for="login-user" class="text-zinc-300 text-sm font-medium">Username / Email</label>
        <div class="relative">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
          <input
            ...
            id="ingat"
            name="remember"
            class="h-4 w-4 rounded border-zinc-700 text-yellow-400 focus:ring-yellow-400/30 bg-zinc-950 accent-yellow-400 cursor-pointer"
          />
          <label for="ingat" class="text-zinc-400 text-sm cursor-pointer select-none">Ingat saya</label>
        </div>
